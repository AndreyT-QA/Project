...
public class TestReservedGift extends AbsBaseTestSuite {
  private static final Logger logger = LogManager.getLogger(TestCreateWishlist.class);

  @Test
  @DisplayName("Зарезервирование подарка")
  public void AddGift() {
    String wishlistName = "Список подарков-reserved";
    String description = "Описание подарков";
    ...
    logger.info("Зарезервирование подарка");
    addingGift.reserveGift();
    addingGift.isReserveGift();
  }
}